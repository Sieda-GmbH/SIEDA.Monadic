...
{
   /// <summary>
   /// Represents a value that may be present ("is some (value)") or absent ("is none (of the
   /// possible values)").
   /// </summary>
   ...
   public readonly struct Maybe<TValue>
   {
      ...
      /// </summary>
      /// <exception cref="MaybeSomeConstructionException">
      ...
      /// <summary>
      /// Creates a <see cref="Maybe{T}"/> with the value of the <see cref="Nullable{U}"/><paramref name="nullableValue"/>.
      /// </summary>
      /// <exception cref="MaybeSomeConstructionException">
      ...
      /// <summary>
      /// <para>
      /// Creates and returns a <see cref="Maybe{T}"/> with value <paramref name="value"/> if
      ...
      /// <summary>
      /// <para>
      /// Creates and returns a <see cref="Maybe{T}"/> with the value of the <see
      /// cref="Nullable{U}"/><paramref name="nullableValue"/> if <paramref name="nullableValue"/>
   ...
   public Maybe<U> Map<U>( Func<TValue, U> func ) => IsSome ? Maybe<U>.From( func( _value ) ) : Maybe<U>.None;
      ...
      /// <para>
      /// Returns <see cref="Maybe{U}.None"/> if <see cref="IsNone"/> == <see langword="true"/> or
      /// it is the result of <paramref name="func"/>.
      /// </para>
      /// </summary>
      /// <typeparam name="U">The type of the new value.</typeparam>
      ...
      /// <summary>
      /// <see cref="Maybe{T}"/>-compatible equality-check for values.
      /// </summary>
      ...
      /// <summary>
      /// Returns this instance's value if <see cref="IsSome"/> == <see langword="true"/>, otherwise
      /// throws a <see cref="MaybeNoneException"/>.
      /// </summary>
      ...
      /// name="msg"/> using the message arguments <paramref name="args"/>.
      /// </summary>
      /// <exception cref="MaybeNoneException"/>
      ...
      /// <para>
      /// Note that <typeparamref name="TFail"/> is relevant for typing the new instance only.
      /// </para>
      /// </summary>
      /// <typeparam name="TFail">
      /// The type of "failure" for the new <see cref="Option{TValue, TFail}"/>.
      /// </typeparam>
      /// <returns>
      ...
      /// <summary>
      /// Custom implementation of <see cref="object.ToString()"/>, wrapping a call to this
      ...
      /// <summary>
      /// Returns <see langword="true"/> iff <see cref="IsSome"/> returns the same boolean for both
      /// objects and, in case of that value being <see langword="true"/>, the method <see
      /// cref="object.Equals(object)"/> of the two instance's values also returns <see langword="true"/>.
      /// </summary>
      ...
      /// </para>
      /// <para>
      /// Note that all <see cref="Maybe{T}"/>-objects, regardless of type <typeparamref
      /// name="TValue"/>, have the same hash code when there is no value, aka when the instance is
      /// <see cref="None"/>.
      /// </para>
      /// </summary>
